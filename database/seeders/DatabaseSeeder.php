    ...
    private function starterPages(mixed $publishedAt): array
    {
        return [
            ...
            [
                ...
                'title_en' => 'Impact',
                'title_ar' => 'الأثر',
                'summary_en' => 'Public impact highlights for youth leadership and service work.',
                'summary_ar' => 'ملامح أثر عامة لعمل القيادة الشبابية والخدمة.',
                'body_en' => 'The impact page gives the public site a bilingual structure for metrics and stories.',
                'body_ar' => 'توفر صفحة الأثر بنية ثنائية اللغة للمؤشرات والقصص.',
                'seo_title_en' => 'GilwellSyria impact',
                'seo_title_ar' => 'أثر جيلويل سوريا',
                'seo_description_en' => 'See GilwellSyria impact metrics and stories.',
                'seo_description_ar' => 'اطلع على مؤشرات وقصص أثر جيلويل سوريا.',
                'hero_image_path' => 'cms/pages/impact-hero.jpg',
                'sort_order' => 4,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
            [
                ...
                'title_en' => 'Partners',
                'title_ar' => 'الشركاء',
                'summary_en' => 'Credibility and partnership information for community collaborators.',
                'summary_ar' => 'معلومات موثوقية وشراكة للمتعاونين المجتمعيين.',
                'body_en' => 'The partners page introduces supporting organizations and invites partnership contact.',
                'body_ar' => 'تعرف صفحة الشركاء بالجهات الداعمة وتدعو للتواصل حول الشراكات.',
                'seo_title_en' => 'GilwellSyria partners',
                'seo_title_ar' => 'شركاء جيلويل سوريا',
                'seo_description_en' => 'Meet GilwellSyria partners and collaboration opportunities.',
                'seo_description_ar' => 'تعرف على شركاء جيلويل سوريا وفرص التعاون.',
                'hero_image_path' => 'cms/pages/partners-hero.jpg',
                'sort_order' => 5,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
            [
                ...
                'title_en' => 'Gallery',
                'title_ar' => 'المعرض',
                'summary_en' => 'Photos and media from training and service activities.',
                'summary_ar' => 'صور ومواد إعلامية من أنشطة التدريب والخدمة.',
                'body_en' => 'The gallery page provides a public structure for albums and media items.',
                'body_ar' => 'توفر صفحة المعرض بنية عامة للألبومات والمواد الإعلامية.',
                'seo_title_en' => 'GilwellSyria gallery',
                'seo_title_ar' => 'معرض جيلويل سوريا',
                'seo_description_en' => 'Browse GilwellSyria training and service media.',
                'seo_description_ar' => 'تصفح مواد جيلويل سوريا للتدريب والخدمة.',
                'hero_image_path' => 'cms/pages/gallery-hero.jpg',
                'sort_order' => 6,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
            [
                ...
                'title_en' => 'News',
                'title_ar' => 'الأخبار',
                'summary_en' => 'Latest organizational updates and announcements.',
                'summary_ar' => 'آخر التحديثات والإعلانات المؤسسية.',
                'body_en' => 'The news page gives the public site a bilingual structure for updates.',
                'body_ar' => 'توفر صفحة الأخبار بنية ثنائية اللغة للتحديثات.',
                'seo_title_en' => 'GilwellSyria news',
                'seo_title_ar' => 'أخبار جيلويل سوريا',
                'seo_description_en' => 'Read GilwellSyria news and announcements.',
                'seo_description_ar' => 'اقرأ أخبار وإعلانات جيلويل سوريا.',
                'hero_image_path' => 'cms/pages/news-hero.jpg',
                'sort_order' => 7,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
            [
                ...
                'title_en' => 'Events',
                'title_ar' => 'الفعاليات',
                'summary_en' => 'Upcoming and recent public activities.',
                'summary_ar' => 'أنشطة عامة قادمة وحديثة.',
                'body_en' => 'The events page introduces public activities and event details.',
                'body_ar' => 'تعرض صفحة الفعاليات الأنشطة العامة وتفاصيلها.',
                'seo_title_en' => 'GilwellSyria events',
                'seo_title_ar' => 'فعاليات جيلويل سوريا',
                'seo_description_en' => 'Find GilwellSyria events and public activities.',
                'seo_description_ar' => 'تابع فعاليات وأنشطة جيلويل سوريا العامة.',
                'hero_image_path' => 'cms/pages/events-hero.jpg',
                'sort_order' => 8,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
            [
                ...
                'title_en' => 'Contact',
                'title_ar' => 'اتصل بنا',
                'summary_en' => 'Contact details for visits, questions, and partnership inquiries.',
                'summary_ar' => 'بيانات التواصل للزيارات والأسئلة واستفسارات الشراكة.',
                'body_en' => 'The contact page supports the v1 public contact and partner-with-us calls to action.',
                'body_ar' => 'تدعم صفحة الاتصال دعوات التواصل والشراكة العامة في النسخة الأولى.',
                'seo_title_en' => 'Contact GilwellSyria',
                'seo_title_ar' => 'اتصل بجيلويل سوريا',
                'seo_description_en' => 'Contact GilwellSyria for questions and partnership inquiries.',
                'seo_description_ar' => 'تواصل مع جيلويل سوريا للأسئلة واستفسارات الشراكة.',
                'hero_image_path' => 'cms/pages/contact-hero.jpg',
                'sort_order' => 9,
                'status' => PublishStatus::Published,
                'published_at' => $publishedAt,
            ],
